...
function toDirectUrl(raw, type = 'image') {
  ...
  if (driveMatch) {
    if (type === 'video') return `https://drive.google.com/file/d/${driveMatch[1]}/preview`
    ...
    <div className="faqadmin__form">
      ...
      <div className="ha__form-grid">
        <div className="faqadmin__field ha__url-field">
          ...
          <input
            type="url"
            placeholder={form.type === 'video' ? 'Cole o link do YouTube ou do Google Drive…' : 'Cole o link do Google Drive…'}
            value={form.imageUrl}
          ...
          <span className="pa__url-hint">
            {form.type === 'video'
              ? 'YouTube: cole o link normal do vídeo. Google Drive: Compartilhar → Qualquer pessoa com o link → cole aqui'
